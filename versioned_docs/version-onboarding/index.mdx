   ...
   <div>
      ...
      <Tabs groupId="browser">
         <TabItem value="chrome" label="Google Chrome">
            ![](images/browser-translate-chrome.png)
         </TabItem>
         <TabItem value="edge" label="Microsoft Edge">
            ![](images/browser-translate-edge.png)
         </TabItem>
         <TabItem value="firefox" label="Mozilla Firefox">
            ![](images/browser-translate-firefox.png)
         </TabItem>
         <TabItem value="safari" label="Apple Safari">
            ![](images/browser-translate-safari.png)
         </TabItem>
      </Tabs>
   </div>
</details>
...
Am erste Schultag wird also überprüft, ob bei sämtlichen Onboarding-Kapiteln (inkl. Unterseiten) ein grünes Gutzeichen angezeigt wird.
