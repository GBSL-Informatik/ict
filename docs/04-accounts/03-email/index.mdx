...
Fügen Sie Empfänger:innen (1), Betreff (2) und Text (3) hinzu. Abschicken können Sie die Nachricht mit einem Klick auf _Senden_ (4).
...
- Um das _Bcc_-Feld einzublenden, klicken Sie ganz rechts im __An__-Feld auf __Bcc__ (5). Emfänger:innen im _Bcc_ sehen nicht, wer die E-Mail sonst noch erhalten hat. Das ist immer dann nützlich, wenn Sie eine E-Mail an mehrere Personen versenden wollen, ohne dass Sie dabei die 
...
<PageReadCheck id="091fb902-d2c2-4e54-bbbc-18ed095506ae" />