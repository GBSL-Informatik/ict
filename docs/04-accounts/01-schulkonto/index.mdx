...
import FaqPasswortRichtlinien from '@site/docs/03-support/01-faq/questions/\_passwortrichtlinien.mdx';

# Schulkonto

Alle unsere Dienste verwenden ein zentrales Benutzerkonto - Sie müssen sich also nur **ein einziges Passwort** merken.
...
<ProgressState id="2909ca8b-e9ac-4095-be87-2402a8d60757" keepPreviousStepsOpen confirm float="right">
1. Auf [gbsl.ch](https://www.gbsl.ch) auf __Quicklinks > Passwort Reset__ klicken.
    <FaqPasswortRichtlinien />
    <BrowserWindow href="https://www.gbsl.ch">
