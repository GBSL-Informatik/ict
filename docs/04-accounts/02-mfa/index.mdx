...
4. Wenn Sie danach einen Code per SMS erhalten, ist die Grundeinrichtung abgeschlossen. Fahren Sie weiter mit dem nächsten Schritt.
   ![--width=350px](images/mfa8.jpg)
   :::danger[Kein Code erhalten?]
   Falls Sie **keinen Code erhalten**, ist die MFA-Grundeinrichtung **noch nicht abgeschlossen**. Suchen Sie unter [Problemlösung](#problemlösungen) nach der passenden Lösung, um das Problem zu beheben. Führen Sie diese Anleitung anschliessend erneut durch.
   :::
5. Damit Sie auch ohne Ihr Mobiltelefon oder Smartphone Zugriff auf Ihr Konto haben, richten Sie zusätzlich zur Authentifizierung per SMS auch noch eine private E-Mail-Adresse als weitere MFA-Option ein.
