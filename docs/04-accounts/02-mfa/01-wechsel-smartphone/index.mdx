...
<Tabs groupId="mfa-smartphone-wechsel" queryString>
    ...
    <TabItem value="access-not-possible" label="Authenticator nicht mehr zugänglich">
        ...
        <Steps>
          1. Melden Sie, dass Ihr Konto zurückgesetzt werden muss. Eine E-Mail-Vorlage dazu erhalten Sie [📧 hier](mailto:ithelp@bernedu.ch?subject=Account%20Sch%C3%BCler%3Ain%20zur%C3%BCcksetzen&body=Guten%20Tag%20%2C%0A%0ABitte%20setzen%20Sie%20meinen%20Account%20zur%C3%BCck%3A%0A%0A%40edu.gbsl.ch%0A%0ATel.%2007%0A%0ABesten%20Dank%20und%20freundliche%20Gr%C3%BCsse). Vergessen Sie nicht, Ihre Mailadresse und Ihre Mobilenummer anzugeben.
