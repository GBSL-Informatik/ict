...
:::danger[Accountverfügbarkeit: August {YEAR}]
export const YEAR = new Date().getFullYear();

Die Lizenzen für die Adobe-Programme sind an das Schuljahr gebunden - die Adobe-Programme können also erst **ab August {YEAR}** installiert werden.
:::
