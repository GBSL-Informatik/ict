...
:::warning[Noch kein eigenes Gerät?]
Falls Sie noch kein eigenes Gerät besitzen, können Sie die Schritte auf dieser Seite vorerst überspringen und direkt mit der [nächsten Seite](./00-intro/index.mdx) fortfahren. Sobald Sie ein eigenes Gerät haben, können Sie jederzeit zu dieser Seite zurückkehren und die Schritte hier durchführen.
:::
...
<Tabs groupId="os">
  <TabItem value="win" label="Windows">
    ...
    3. Klappen Sie das Benutzerkonto aus, dessen Kontotyp Sie ändern möchten, und klicken Sie auf __Kontotyp ändern__.
