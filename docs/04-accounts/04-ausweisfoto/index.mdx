...
<ProgressState id="4cbc6a15-d54b-46f3-9c9f-413f90bf4206" keepPreviousStepsOpen allOpen confirm float="right">
  ...
  2. Gehen Sie auf [https://evt.apps.be.ch](https://evt.apps.be.ch). Wählen Sie als Schule __Gymnasien Biel-Bienne (GBJB/GBSL)__ und melden Sie sich mit Ihrem **Schulkonto** an.
      ...
      #### Grosse Bildschirme (Desktop, Laptop):
      ![--width=200px](images/evento-mein-profil.png)
      ...auf das Personen-Symbol oben rechts und anschliessend auf __Mein Profil__.
      ::br
      #### Kleine Bildschirme (Smartphone):
      ![--width=200px](images/evento-mein-profil-mobile.png)
      ...auf das Menü-Symbol oben rechts und anschliessend auf __Mein Profil__ ganz unten.
      :::
